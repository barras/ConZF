...
The materialization lemma and Theorem~\ref{thm:repl} are constructive.
Excluded middle enters with the ordinals and with the classical
reading of first-order logic. We have not investigated what the
recursion gives in the type theory without excluded middle, where the
natural target would be an intuitionistic set theory with Replacement
or Collection.
