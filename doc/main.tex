...
$\varphi$ only. Classically the two are equivalent, and Friedman's translation
...
$\mathrm{IZF}_R$, which, as far as we know, is not known.
...
The author thanks Lo\"{\i}c Pujet for many discussions on the
consistency strength of $\CIC$ and its fragments, which prompted this
work.
